...
public class QLNhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        but_indsnhanvien = new javax.swing.JPanel();
        ...
        jButton1.setBounds(970, 110, 80, 25);
        ...
        but_indsnhanvien.setBackground(new java.awt.Color(153, 153, 153));
        but_indsnhanvien.setForeground(new java.awt.Color(255, 255, 255));
        but_indsnhanvien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                but_indsnhanvienMouseClicked(evt);
            }
        });
        ...
        jLabel18.setText("In danh sách Nhân Viên");

        javax.swing.GroupLayout but_indsnhanvienLayout = new javax.swing.GroupLayout(but_indsnhanvien);
        but_indsnhanvien.setLayout(but_indsnhanvienLayout);
        but_indsnhanvienLayout.setHorizontalGroup(
            but_indsnhanvienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(but_indsnhanvienLayout.createSequentialGroup()
                .addComponent(jLabel18, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                .addContainerGap())
        );
        but_indsnhanvienLayout.setVerticalGroup(
            but_indsnhanvienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel18, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        );

        jPanel1.add(but_indsnhanvien);
        but_indsnhanvien.setBounds(930, 730, 200, 30);
        ...
        jButton2.setBounds(390, 730, 80, 30);
...
//               
    ...
    private void but_indsnhanvienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_but_indsnhanvienMouseClicked
         try {
             //Connection con = JDBCConnection.getJDBCConnection();
             Connection con = JDBCConnection.getJDBCConnection();
             String dir = "F:\\Java Swing Root(main)\\Ontap\\src\\report\\report\\InThongTinNhanVien.jrxml";
             String pdf = "F:\\Java Swing Root(main)\\Ontap\\src\\report\\report\\InThongTinNhanVien.jrxml";
    ...
    }//GEN-LAST:event_but_indsnhanvienMouseClicked
...
*/
    ...
    private javax.swing.JPanel but_indsnhanvien;
